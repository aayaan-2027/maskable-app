...
LABELS = {
    ...
    "occupation": {
        "en": ["occupation", "profession", "job"],
        "ur": ["پیشہ", "ملازمت"],
        "ar": ["المهنة", "الوظيفة"],
    },
    "employer": {
        "en": ["employer", "employer name", "company name", "company"],
        "ur": ["آجر", "ملازم دہندہ", "ملازمت دینے والا", "کمپنی کا نام"],
        "ar": ["صاحب العمل", "اسم صاحب العمل", "جهة العمل", "الشركة"],
    },
    "issuing_place": {
        "en": ["place of issue", "issuing place", "issued at", "issued by"],
        "ur": ["جاری کرنے کی جگہ", "جاری ہونے کی جگہ", "جاری کرنے کا مقام"],
        "ar": ["مكان الإصدار", "مكان الاصدار", "صادر عن"],
    },
    "signature": {
        "en": ["signature"],
        "ur": ["دستخط", "دستخطی"],
